...
client.login('NTk2Nzc2MDM0NDczNDc2MDk3.XYzuWg.G8hW7FPmQjhZWib5PhvVLmN69e8')

client.login('NTk4ODk5MjE4NTI2MjQwNzg4.XY3TxQ.hYu31r-Z4qmsxHmMLc_iBhkuRQo')
...
client.on('message', function (message) {
    if (message.content === "kizaru") {
        message.channel.sendMessage('**AKBAR WLD L97BA KYN FDISCORD,** :( :joy: ')
        console.log('répond à tfq')
    }
})
client.on('message', function (message) {
